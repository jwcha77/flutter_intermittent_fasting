...
class NeonCircularTimerState extends State<NeonCircularTimer> with TickerProviderStateMixin {
  ...
  int get currentTime => (_controller!.duration! * _controller!.value).inSeconds;
                    ...
                    children: <Widget>[
                      ...
                      widget.isTimerTextShown
                          ? Align(
                              ...
                              child: Text(
                                time,
                                style: widget.textStyle ?? Theme.of(context).textTheme.displaySmall,
                              ),
                            )
                          : Container(),
                    ],
